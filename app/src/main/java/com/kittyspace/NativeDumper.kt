...
object NativeDumper {
    init {
        try {
            ...
            android.util.Log.i("NativeDumper", "Native library 'kittydumper' loaded successfully!")
        } catch (e: Throwable) {
            android.util.Log.e("NativeDumper", "Failed to load native library 'kittydumper'!", e)
        }
    }
